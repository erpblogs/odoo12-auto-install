...
sudo apt-get update
sudo apt-get install python3.7 python3.7-dev python3.7-minimal python3.7-venv -y
...
# Install
sudo python3.7 -m pip install -r $OE_HOME_EXT/requirements.txt
sudo python3.7 -m pip install -r $OE_HOME_EXT/doc/requirements.txt
...
#quangtv edit
sudo python3.7 -m pip install num2words ofxparse Pillow
...
sudo python3.7 -m pip install lxml pypdf2 Babel passlib Werkzeug decorator python-dateutil pyyaml psycopg2 psycopg2-binary psutil html2text docutils pillow reportlab ninja2 requests gdata XlsxWriter vobject python-openid pyparsing pydot mock mako Jinja2 ebaysdk feedparser xlwt psycogreen suds-jurko pytz pyusb greenlet xlrd chardet libsass

#install python-docx
sudo git clone https://github.com/python-openxml/python-docx.git $OE_HOME/python-docx/
sudo python3.7 $OE_HOME/python-docx/setup.py install

# Odoo use old pyllow we must reinstall new version.
sudo python3.7 -m pip uninstall pillow -y

sudo python3.7 -m pip install pypdf2 pyyaml psycopg2-binary html2text pillow ninja2 gdata chardet libsass
